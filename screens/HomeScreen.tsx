  ...
  return (
    <div className="flex-1 flex flex-col h-full animate-fade-in-up">
      ...
      <header className="flex-1 flex flex-col justify-center items-center text-center space-y-6 pt-10 px-6">
        ...
        {/* Visual Element */}
        <div className="w-full max-w-[500px] aspect-[4/5] mt-8 rounded-t-full overflow-hidden shadow-xl shadow-primary/10 border-4 border-white/50 dark:border-white/5 mx-auto relative group">
